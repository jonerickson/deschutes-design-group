  ...
  return {
    ...
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links': 'hsl(var(--spark))',
        '--tw-prose-links-hover': 'hsl(var(--spark))',
        '--tw-prose-underline': 'hsl(var(--spark) / 0.3)',
        '--tw-prose-underline-hover': 'hsl(var(--spark))',
        ...
        '--tw-prose-invert-links': 'hsl(var(--spark))',
        '--tw-prose-invert-links-hover': 'hsl(var(--spark))',
        '--tw-prose-invert-underline': 'hsl(var(--spark) / 0.3)',
        '--tw-prose-invert-underline-hover': 'hsl(var(--spark))',
